		...
		<div className={s.contactBox}>
			...
			<div className={s.formBox}>
					<form onSubmit={formik.handleSubmit} className={s.group}>
						<input className={s.input} placeholder="Your name" type="text" required {...formik.getFieldProps('name')}/>
						{formik.touched.name && formik.errors.name && <div style={{color: 'red'}}>{formik.errors.name}</div>}
						<input className={s.input} placeholder="Your email" type="email" required {...formik.getFieldProps('email')}/>
						{formik.touched.email && formik.errors.email && <div style={{color: 'red'}}>{formik.errors.email}</div>}
						<input className={s.input} placeholder="Your message" type="text" required {...formik.getFieldProps('message')}/>
