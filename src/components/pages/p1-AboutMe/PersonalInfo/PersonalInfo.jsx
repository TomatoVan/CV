    ...
    <div className={s.personalBox}>
      <div className={s.personalInfo}>
        ...
        <div className={s.personalDesc}>
          I`m a frontend developer who has a results-focused attitude to creating SPA, using
          React(JS/TS), Redux. I spend my free time in Codewars and programming tutorials because in
          the future I see myself as a Senior FrontEnd developer.
